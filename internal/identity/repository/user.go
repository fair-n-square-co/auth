...
// ErrConflict is returned when an insert violates a unique constraint — e.g. a
// concurrent first login created the same (issuer, subject) first. The service
// treats it as a signal to re-read and stay idempotent.
